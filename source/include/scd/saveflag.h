...
#define  HISDATA_KWHTABCODE			52		//电度表码-Modify Plan
...
#define HISDEV_BREAK             300     //开关运行情况
#define HISDEV_TERMINAL          10000   //RTU运行情况
#define HISDEV_CHAN              10002   //通道运行情况
#define HISDEV_ANALOG_OL         10003   //模拟量越限情况
#define HISDEV_HOST				 10004   //主机运行情况
