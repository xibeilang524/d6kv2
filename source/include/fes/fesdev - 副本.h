...
public:
	...
	*/
	virtual int read_dev(unsigned char* buf, int len,unsigned int nTimeOut=0) = 0;
	/**
	@brief 写设备
...
public:
	...
	*/
	...
	virtual int read_dev(unsigned char* buf, int len,unsigned int nTimeOut=0);
...
public:
	...
	*/
	...
	virtual void close_dev(void);
	virtual int read_dev(unsigned char* buf, int len,unsigned int nTimeOut=0);
	//int read_dev(unsigned char* buf, int len,unsigned int nTimeOut);
	virtual int write_dev(unsigned char* buf, int len); 
