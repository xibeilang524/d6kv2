...
#ifndef IEC104_TYPE_DEF_H_
#define IEC104_TYPE_DEF_H_
...
{
	SEL_FILE		= 0x00,	//选择文件
	REQUTST_FILE	= 0x01,	//请求文件
	REQUTST_NODE	= 0x02,	//请求节
	CONFIRM_NODE	= 0x03,	//节认可
	CONFIRM_FILE	= 0x04,	//文件认可
	REQUTST_DIR		= 0x05	//请求目录
...
struct IEC104_CONFIG
{
	...
	unsigned short setpoint_begin; ///<设点起始地址
