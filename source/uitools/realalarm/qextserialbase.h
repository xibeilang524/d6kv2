...
#define TTY_PORTABILITY_WARNING(m_event_status)
#else
#define TTY_PORTABILITY_WARNING(m_event_status) qWarning(m_event_status)
#endif /*_TTY_NOWARN_PORT_*/
#ifdef _TTY_NOWARN_
#define TTY_WARNING(m_event_status)
#else
#define TTY_WARNING(m_event_status) qWarning(m_event_status)
#endif /*_TTY_NOWARN_*/
