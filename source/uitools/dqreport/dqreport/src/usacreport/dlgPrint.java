...
public class dlgPrint extends JDialog {
  ...
  public dlgPrint(Frame frame, String title, boolean modal) {
  ...
  private void jbInit() throws Exception {
    ...
    panel1.add(jLabel8,   new XYConstraints(151, 20, 17, 27));
      panel1.add(jButOK, new XYConstraints(85, 150, 80, 28));
      panel1.add(jButCan, new XYConstraints(210, 150, 80, 28));
      int i;
    for(i=2000;i<2010;i++)
    {
