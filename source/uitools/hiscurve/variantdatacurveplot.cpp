...
VariantDataCurvePlot::VariantDataCurvePlot( QWidget * parent /*= NULL*/ )
:QwtPlot(parent)
{
	setAutoReplot(false);
...
VariantDataCurvePlot::~VariantDataCurvePlot()
{

}

void VariantDataCurvePlot::showCurve( QwtPlotItem* item, bool on )
{
...
void VariantDataCurvePlot::clear()
{
	
}

void VariantDataCurvePlot::alignScales()
{
